    ...
    return [
      {
        ...
        floors: 6,
        departments: ['Cổng 4 (Giải Phóng - Vào K1, K2)', 'Sảnh tiếp đón & đăng ký khám', 'Khám Tim Mạch & Nội Khoa', 'Khám Nhi, Sản, TMH, Mắt', 'Nhà thuốc BV Bạch Mai Số 1'],
        crowdLevel: 'high',
        avgWaitMins: 15,
        x: -45,
        z: 25,
      ...
      },
      {
        ...
        floors: 5,
        departments: ['Cổng 1 (78 Giải Phóng - Vào A9)', 'Cấp Cứu A9 24/7', 'Phân loại bệnh nhân Triage', 'Hồi sức cấp cứu ICU'],
        crowdLevel: 'medium',
        avgWaitMins: 0,
        x: 45,
        z: 35,
